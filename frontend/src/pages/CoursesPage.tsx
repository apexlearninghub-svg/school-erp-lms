      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <div className="p-4 bg-white dark:bg-[#1E293B] rounded-2xl shadow-lg shadow-[#862fe7]/10 mb-6 inline-block">
            <BookOpen className="w-10 h-10 text-[#862fe7]" />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {classes.map((cls) => (
            <motion.div
              key={cls}
              whileHover={{ y: -5 }}
              className="bg-white dark:bg-[#1E293B] p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-[#862fe7]/10 hover:border-[#862fe7]/30 transition-all group"
            >
              <div className="w-12 h-12 bg-slate-50 dark:bg-slate-800 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#862fe7]/10 transition-colors">
                <GraduationCap className="w-6 h-6 text-slate-400 group-hover:text-[#862fe7] transition-colors" />
              </div>
              ...
              <Link to="/register" className="text-[#862fe7] text-sm font-semibold hover:text-[#ad6df4] transition-colors flex items-center gap-1">
