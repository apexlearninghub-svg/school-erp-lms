...
import { Server, Activity, Database, HardDrive, ShieldCheck, Settings, AlertCircle, RefreshCw, Cpu, Wifi } from 'lucide-react';
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6 flex flex-col pb-6 pr-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div variants={itemVariants}>
          <Card className="flex items-center gap-4 relative overflow-hidden group h-full">
