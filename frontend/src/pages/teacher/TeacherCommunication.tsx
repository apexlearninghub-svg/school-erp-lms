        ...
        <motion.div variants={itemVariants} className="lg:col-span-1 h-fit sticky top-0">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            <div className="space-y-1">
              ...
              <input required value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Science Fair Tomorrow" className="w-full px-4 py-2 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 rounded-xl text-sm outline-none focus:border-[#862fe7] dark:text-white" />
            </div>
            ...
            {targetAudience === 'class' && (
              <div className="space-y-1">
                ...
                <select required value={selectedClass} onChange={e => setSelectedClass(e.target.value)} className="w-full px-4 py-2 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 rounded-xl text-sm outline-none focus:border-[#862fe7] dark:text-white">
